...
class Visualizer:
    ...
    def show_scan_slice(
        ...
        if (
            filename_end == "-difference.png"
            or filename_end == "-recovered-difference.png"
            or filename_end == "-delta.png"
            or filename_end == "-recovered-delta.png"
        ):
    ...
    def _show_recovered_scan_difference_slice(self, scan: int, dim: int, slice: int):
        ...
        scan_difference = abs(scan_test - scan_predicted)
        self.show_scan_slice(
            scan_difference, scan, dim, slice, "DIFFERENCE", "-recovered-difference.png"
        )
